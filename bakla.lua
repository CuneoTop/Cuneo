...
createButton("ESPButton", "ESP", UDim2.new(1, -130, 0, 10), function()
    toggleESP()
end)

createButton("AimbotToggleButton", "Toggle Aimbot", UDim2.new(1, -130, 0, 60), function()
    aimbotEnabled = not aimbotEnabled
    toggleAimbot(aimbotEnabled)
end)

createButton("AimbotHoldButton", "Hold Aimbot", UDim2.new(1, -130, 0, 110), function()
    toggleAimbot(true)
end)

createButton("FPSBoostButton", "FPS Boost", UDim2.new(1, -130, 0, 160), function()
    toggleFPSBoost()
end)
